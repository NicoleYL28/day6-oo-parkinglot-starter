...
public class ParkingLotTest {
    ...
    // Given a parking lot, and a car, When park the car, Then return a parking ticket.
    @Test
    void should_return_parking_ticket_when_park_given_parking_lot_and_car_by_standard_boy() {
        ParkingLot parkingLot = new ParkingLot(10);
        Car car = new Car();
    ...
    // Given a parking lot with a parked car, and a parking ticket, When fetch the car, Then return the parked car.
    @Test
    void should_return_parked_car_when_fetch_given_parking_lot_with_parked_car_and_correct_parking_ticket_by_standard_boy() {
    ...
    // Given a parking lot with two parked cars, and two parking tickets, When fetch the car twice, Then return the right car with each ticket
    @Test
    void should_return_right_car_with_each_ticket_when_fetch_twice_given_parking_lot_with_two_parked_cars_and_two_correct_parking_tickets_by_standard_boy() {
    ...
    // Given a parking lot, and a wrong parking ticket, When fetch the car, Then return nothing.
    @Test
    void should_throw_error_message_when_fetch_given_parking_lot_and_wrong_parking_ticket_by_standard_boy() {
    ...
    // Given a parking lot without any position, and a car, When park the car, Then return nothing
    @Test
    void should_throw_error_message_when_park_given_parking_lot_is_full_and_car_by_standard_boy() {
    ...
    // The standard parking boy(multi)
    @Test
    ...
    @Test
    void should_throw_error_message_when_fetch_given_parking_lot_with_two_parking_lots_and_parked_car_and_no_ticket_by_standard_boy() {
    ...
    @Test
    void should_throw_error_message_when_fetch_given_two_parking_lots_and_parking_lot_and_used_parking_ticket_by_standard_boy() {
